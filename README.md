...
1. **CIT Resewn/Optifine's CIT** (roughly 95% finished, may have bugs)
...
6. **Custom Entity Textures** (planned)
...
**A:** I don't know, honestly. Considering this is nearly not an only project I'm currently working on, I'm not even sure when I'll be able to actively develop it again. I mean, even the logo you see on top of readme is not in it's final state, lol. 
...
**Q:** Why don't you release it on CF/Modrinth?

**A:** I can't consider my mod to be nearly finished enough to be released even in beta on Curseforge or Modrinth. Literally 90% of description's content would be "it's planned, it's meant" etc. Though, I might do that if there'll be enough requests.
