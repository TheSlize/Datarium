...
**Q:** Был ли использован ИИ при создании мода? Если да - почему?

**A:** Да. Однако, ИИ тут используется как **инструмент**, а не моя **замена**. Это важно понимать. Поверьте, ИИ склоннен галлюцинировать и совершать глупые ошибки. Если б я был плохим кодером только от использования ИИ, мод бы вообще не увидел свет.